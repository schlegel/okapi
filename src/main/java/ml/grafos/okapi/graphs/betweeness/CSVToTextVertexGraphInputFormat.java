...
public class CSVToTextVertexGraphInputFormat extends TextEdgeInputFormat<IntWritable, IntWritable> {
    ...
    public EdgeReader<IntWritable, IntWritable> createEdgeReader(InputSplit inputSplit, TaskAttemptContext taskAttemptContext) throws IOException {
        ...
        return new ReverseEdgeDuplicator<IntWritable, IntWritable>(edgeReader);
    }
