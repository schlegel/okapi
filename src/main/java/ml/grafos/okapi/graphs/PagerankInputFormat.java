...
public class PagerankInputFormat extends TextEdgeInputFormat<IntWritable, IntWritable> {

    private static final Logger INPUT_FORMAT_LOGGER = LoggerFactory.getLogger(PagerankInputFormat.class);
